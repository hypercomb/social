...
// What stays asleep until asked for — loaded by the preloader on its trigger.
import { sleepers } from '../../../hypercomb-essentials/src/sleeping-effects'
...
export class App implements AfterViewInit {
  ...
  private readonly startRegisteredBees = async (): Promise<void> => {
    ...
    // THE SLEEPING LANE: what the package leaves asleep, dev leaves asleep —
    // queens until their word, views until entered, bees until their effect
    // (generated by prepare, same rules as the package build).
    preloader?.useSleepers?.(sleepers)
