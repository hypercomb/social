export const provinces1000 = {
  ...
  "data": {
    ...
    "tables": [
      {
        "name": "data",
        "schema": "++cellId,kind,[hive+isActive+isDeleted],sourceId,uniqueId,options,name,type,dateCreated,isActive,isBranch,isDeleted,isHidden,isLocked,isHive,isNewHive,isRecenter,[hiveId+isDeleted],[hive+sourceId],[isSelected+isLocked],*tagIds",
        "rowCount": 745
      },
      {
        "name": "tags",
