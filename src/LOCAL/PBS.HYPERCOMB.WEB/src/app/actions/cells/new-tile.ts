...
export class NewTileAction extends ActionBase<BaseContext> {
    ...
    public override enabled = (payload: BaseContext): boolean => {
        return !!this.coordinate
    }

    // creates a new tile only if the target coordinate is empty
    public run = async (payload: BaseContext<Event>): Promise<void> => {
