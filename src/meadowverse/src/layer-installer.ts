// meadowverse/src/layer-installer.ts
//
// Relocated from hypercomb-shared/core — meadowverse is the sole remaining
// consumer. The hypercomb shells install through ensure-install's
// applyVerifiedFiles / sentinel resync, and the forward path is the pull
// replication protocol (documentation/install-by-replication.md): this
// manifest-driven installer is meadowverse's bootstrap client until that
// shell adopts the closure/inventory walker.

import { type LocationParseResult } from '../../hypercomb-shared/core/initializers/location-parser'
import { bytesMatchSignature, type SealedInstallPackage, validateSealedPackage } from '../../hypercomb-shared/core/sealed-package'
