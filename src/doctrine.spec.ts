...
describe('doctrine ratchets', () => {
  ...
  it('one behaviour per feature — a game directory holds exactly one drone', () => {
    ...
    visit(join(ROOT, 'hypercomb-essentials/src/games'))
    expect(over, 'a game directory grew a second behaviour — make it a dependency the one bee wires').toEqual([])
  })

  it('a dependency never registers — registration is the bee\'s act (frozen debt drains)', () => {
    // A non-bee file that calls ioc.register / registerShellSurface, or
    ...
    assertRatchet(actual.sort(), [
      ...
      'hypercomb-essentials/src/clipboard/clipboard.queen.ts',
      'hypercomb-essentials/src/clipboard/clipboard.service.ts',
      'hypercomb-essentials/src/comfy/comfy.queen.ts',
      'hypercomb-essentials/src/comfy/comfy.service.ts',
      ...
      'hypercomb-essentials/src/commands/aliases/participant-aliases.ts',
      'hypercomb-essentials/src/commands/annotate.queen.ts',
      'hypercomb-essentials/src/commands/arrange.queen.ts',
      'hypercomb-essentials/src/commands/ask.queen.ts',
      'hypercomb-essentials/src/commands/background.queen.ts',
      'hypercomb-essentials/src/commands/behavior.queen.ts',
      'hypercomb-essentials/src/commands/brief.queen.ts',
      'hypercomb-essentials/src/commands/brood.queen.ts',
      'hypercomb-essentials/src/commands/builds.queen.ts',
      'hypercomb-essentials/src/commands/canonical-reference.service.ts',
      'hypercomb-essentials/src/commands/collections-view.queen.ts',
      'hypercomb-essentials/src/commands/consolidate-content.queen.ts',
      'hypercomb-essentials/src/commands/context.queen.ts',
      'hypercomb-essentials/src/commands/create.queen.ts',
      'hypercomb-essentials/src/commands/debug.queen.ts',
      'hypercomb-essentials/src/commands/decoration-kind-index.ts',
      'hypercomb-essentials/src/commands/decoration-manifest.ts',
      'hypercomb-essentials/src/commands/decoration.service.ts',
      'hypercomb-essentials/src/commands/deposit.queen.ts',
      'hypercomb-essentials/src/commands/domain.queen.ts',
      'hypercomb-essentials/src/commands/download.queen.ts',
      'hypercomb-essentials/src/commands/empty-long-press.input.ts',
      'hypercomb-essentials/src/commands/enroll.queen.ts',
      'hypercomb-essentials/src/commands/forget.queen.ts',
      'hypercomb-essentials/src/commands/genome.queen.ts',
      'hypercomb-essentials/src/commands/grant.queen.ts',
      'hypercomb-essentials/src/commands/history.queen.ts',
      'hypercomb-essentials/src/commands/hive.queen.ts',
      'hypercomb-essentials/src/commands/i18n-override.queen.ts',
      'hypercomb-essentials/src/commands/interest.queen.ts',
      'hypercomb-essentials/src/commands/into.queen.ts',
      'hypercomb-essentials/src/commands/keyword-suggestions.view.ts',
      'hypercomb-essentials/src/commands/keyword.queen.ts',
      'hypercomb-essentials/src/commands/keywords.queen.ts',
      'hypercomb-essentials/src/commands/lanes.queen.ts',
      'hypercomb-essentials/src/commands/language.queen.ts',
      'hypercomb-essentials/src/commands/lightbox.queen.ts',
      'hypercomb-essentials/src/commands/mobile.queen.ts',
      'hypercomb-essentials/src/commands/postit.queen.ts',
      'hypercomb-essentials/src/commands/present.queen.ts',
      'hypercomb-essentials/src/commands/publications-view.queen.ts',
      'hypercomb-essentials/src/commands/reference.queen.ts',
      'hypercomb-essentials/src/commands/remove.queen.ts',
      'hypercomb-essentials/src/commands/requires.queen.ts',
      'hypercomb-essentials/src/commands/restore.queen.ts',
      'hypercomb-essentials/src/commands/rewind.queen.ts',
      'hypercomb-essentials/src/commands/save-session.queen.ts',
      'hypercomb-essentials/src/commands/scroller.queen.ts',
      'hypercomb-essentials/src/commands/slice.queen.ts',
      'hypercomb-essentials/src/commands/snapshot.queen.ts',
      'hypercomb-essentials/src/commands/spotlight.queen.ts',
      'hypercomb-essentials/src/commands/square-tile-view.queen.ts',
      'hypercomb-essentials/src/commands/sweep.queen.ts',
      'hypercomb-essentials/src/commands/tags-view.queen.ts',
      'hypercomb-essentials/src/commands/template.queen.ts',
      'hypercomb-essentials/src/commands/theme.queen.ts',
      'hypercomb-essentials/src/commands/title.queen.ts',
      'hypercomb-essentials/src/commands/translate-sweep.queen.ts',
      'hypercomb-essentials/src/commands/translation.service.ts',
      'hypercomb-essentials/src/commands/tree.queen.ts',
      'hypercomb-essentials/src/commands/upgrade.queen.ts',
      'hypercomb-essentials/src/commands/utterance/spoken-habits.ts',
      'hypercomb-essentials/src/commands/utterance/utterance-reader.ts',
      'hypercomb-essentials/src/commands/verify-history.queen.ts',
      'hypercomb-essentials/src/commands/view-current.queen.ts',
      'hypercomb-essentials/src/commands/view-library.queen.ts',
      'hypercomb-essentials/src/commands/view.bee.ts',
      ...
      'hypercomb-essentials/src/history/global-time-clock.service.ts',
      'hypercomb-essentials/src/history/history-cursor.service.ts',
      'hypercomb-essentials/src/history/history.service.ts',
      'hypercomb-essentials/src/history/layer-slot-registry.ts',
      'hypercomb-essentials/src/history/order-projection.ts',
      'hypercomb-essentials/src/history/prune.queen.ts',
      'hypercomb-essentials/src/history/prune.service.ts',
      'hypercomb-essentials/src/history/revise.queen.ts',
      'hypercomb-essentials/src/history/snapshots-slot.ts',
      'hypercomb-essentials/src/history/undo.queen.ts',
      'hypercomb-essentials/src/keyboard/escape-cascade.ts',
      ...
      'hypercomb-essentials/src/move/desktop-move.input.ts',
      'hypercomb-essentials/src/move/layer-transfer.service.ts',
      'hypercomb-essentials/src/move/layout.queen.ts',
      'hypercomb-essentials/src/move/layout.service.ts',
      'hypercomb-essentials/src/move/touch-move.input.ts',
      'hypercomb-essentials/src/navigation/back-gesture.service.ts',
      'hypercomb-essentials/src/navigation/hex-detector.ts',
      'hypercomb-essentials/src/navigation/input-gate.service.ts',
      'hypercomb-essentials/src/navigation/input-mode-stack.service.ts',
      'hypercomb-essentials/src/navigation/mode-registry.service.ts',
      'hypercomb-essentials/src/navigation/touch/touch-gesture.coordinator.ts',
      'hypercomb-essentials/src/navigation/view-back.ts',
      'hypercomb-essentials/src/navigation/zoom/fit.queen.ts',
      'hypercomb-essentials/src/navigation/zoom/mousewheel-zoom.input.ts',
      'hypercomb-essentials/src/navigation/zoom/pinch-zoom.input.ts',
      'hypercomb-essentials/src/pheromones/intake-filter.ts',
      'hypercomb-essentials/src/pheromones/pheromone-deposits.ts',
      'hypercomb-essentials/src/pheromones/pheromone-marks.ts',
      'hypercomb-essentials/src/preferences/mobile-mode.service.ts',
      'hypercomb-essentials/src/preferences/settings.ts',
      'hypercomb-essentials/src/preferences/zoom-settings.ts',
      'hypercomb-essentials/src/presentation/avatars/agent-avatar.ts',
      'hypercomb-essentials/src/presentation/background/background-theme.service.ts',
      'hypercomb-essentials/src/presentation/background/canvas-background.service.ts',
      'hypercomb-essentials/src/presentation/grid/axial-service.ts',
      'hypercomb-essentials/src/presentation/grid/center-slot-tracker.ts',
      'hypercomb-essentials/src/presentation/grid/hex-label.atlas.ts',
      'hypercomb-essentials/src/presentation/grid/hex-sdf.shader.ts',
      'hypercomb-essentials/src/presentation/screensaver/screensaver.queen.ts',
      'hypercomb-essentials/src/presentation/tiles/hide.queen.ts',
      'hypercomb-essentials/src/presentation/tiles/index.nurse.ts',
      'hypercomb-essentials/src/presentation/tiles/organism.queen.ts',
      'hypercomb-essentials/src/presentation/tiles/tile-source-registry.ts',
      ...
      'hypercomb-essentials/src/sequence/frame.service.ts',
      'hypercomb-essentials/src/sequence/pattern.queen.ts',
      'hypercomb-essentials/src/sequence/sequence-editor.bee.ts',
      'hypercomb-essentials/src/sequence/sequence.queen.ts',
      'hypercomb-essentials/src/sequence/sequence.service.ts',
      ...
      'hypercomb-essentials/src/substrate/heal.queen.ts',
      'hypercomb-essentials/src/substrate/reroll.queen.ts',
      'hypercomb-essentials/src/substrate/substrate.queen.ts',
      ...
      'hypercomb-essentials/src/workflow/workflow-slot.ts',
      'hypercomb-essentials/src/workflow/workflow-step-registry.ts',
      'hypercomb-essentials/src/workflow/workflow.queen.ts',
