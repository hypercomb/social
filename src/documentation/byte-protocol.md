...
- `@hypercomb/essentials` axial coordinate: `hypercomb-essentials/src/presentation/grid/axial-coordinate.ts`
- `@hypercomb/essentials` axial service: `hypercomb-essentials/src/presentation/grid/axial-service.ts`
