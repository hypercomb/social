...
- **PixiHostWorker** — the architect. sets up the rendering infrastructure and announces it to the colony.
- **ShowCellDrone** — the builder. receives the architect's signal and draws the hex grid.
