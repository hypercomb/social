...
- **Not checked:** types, tests. A draft is judged by running it. "Deploy later" — publishing a draft to a host so followers can take it — is the next act and is not built.
