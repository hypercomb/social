...
2. [network-architecture.md](network-architecture.md) -- participants, hosts, the mesh, and how content flows
...
- filenames use hyphens: `byte-protocol.md`, `core-processor-architecture.md`.
