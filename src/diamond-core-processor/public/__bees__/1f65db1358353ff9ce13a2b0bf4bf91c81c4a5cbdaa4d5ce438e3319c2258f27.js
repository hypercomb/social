// hypercomb-essentials/src/diamondcoreprocessor.com/presentation/avatars/avatar-swarm.drone.ts
import { Drone } from "@hypercomb/core";
import { Container, Geometry, Mesh, Texture } from "pixi.js";

// hypercomb-essentials/src/diamondcoreprocessor.com/presentation/avatars/bee-swarm.shader.ts
...
var AvatarSwarmDrone = class extends Drone {
  ...
  genotype = "sharing";
  description = "Renders real-time peer avatar cursors on the hex grid from mesh presence events.";
  ...
  #initRendering = () => {
    ...
    this.onEffect("render:set-bees-visible", ({ visible }) => {
