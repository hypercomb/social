...
var tilePropertiesCacheKey = (parentSegments, cellName) => {
  if (!cellName) return void 0;
...
var ShowCellDrone = class _ShowCellDrone extends Drone {
   ...
   */
  async #orderByIndex(dir, names, localCellSet, parentSegments, readOnly = false) {
    const axial = this.resolve("axial");
   ...
   */
  async #resolveCellOrder(dir, union, localCellSet, _lineage) {
    if (this.#clipboardView) {
