...
var PixiHostWorker = class extends Worker {
  ...
  act = async () => {
    ...
    window.__hcBoot?.("PixiHostWorker.act \u2192 Application.init() starting");
    ...
    window.__hcBoot?.(`Application.init() done (${pixiInitMs.toFixed(0)}ms)`);
    ...
    window.__hcBoot?.("render:host-ready emitted");
  };
};
