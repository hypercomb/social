...
var LOCAL_RELAY = "ws://localhost:7777";
var NostrMeshDrone = class extends Drone {
  ...
  publish = async (kind, sig, payload, extraTags) => {
    ...
    if (!s) return false;
    const tags = [["x", s]];
    const callerHasExpiration = Array.isArray(extraTags) && extraTags.some((t) => Array.isArray(t) && t[0] === "expiration");
  ...
  sendHcBlock = (pubkey) => {
    ...
    this.note("hc-block:sent", void 0, void 0, void 0, void 0);
  ...
  sendHcClear = () => {
    ...
    this.note("hc-clear:sent", void 0, void 0, void 0, void 0);
