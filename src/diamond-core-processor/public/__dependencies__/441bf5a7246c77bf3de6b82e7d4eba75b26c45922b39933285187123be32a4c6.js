...
var writeCellProperties = async (cellDir, updates, cacheKey) => {
  ...
  await writable.close();
  EffectBus3.emit("cell:0000-changed", {
...
import { EffectBus as EffectBus5, SignatureService } from "@hypercomb/core";
...
import { QueenBee as QueenBee13, EffectBus as EffectBus11, hypercomb as hypercomb3 } from "@hypercomb/core";
  ...
  async execute(args) {
    ...
    for (const name of targets) {
      try {
        ...
        EffectBus11.emit("cell:removed", { cell: name, groupId });
      } catch (e) {
...
import { QueenBee as QueenBee14, EffectBus as EffectBus12, hypercomb as hypercomb4 } from "@hypercomb/core";
...
import { EffectBus as EffectBus14, SignatureService as SignatureService2, I18N_IOC_KEY as I18N_IOC_KEY3 } from "@hypercomb/core";
