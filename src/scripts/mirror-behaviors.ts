...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    members: [
      ...
      ['border', 'Tile border style — neon glow on/off; neon | off', `${E}/commands/border.queen.ts`],
  ...
  },
  {
    ...
    members: [
      ...
      ['swirl', 'Arrange tiles into the index spiral'],
      ...
      ['branch', 'Name a path or signature for command autocomplete'],
  ...
  },
  {
    ...
    members: [
      ['help', 'Show reference', `${E}/commands/help.queen.ts`],
