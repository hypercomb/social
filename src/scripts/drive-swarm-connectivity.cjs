...
// There is no availability gate to bypass any more: the sharer serves
// what they announce while present, so this joins exactly as a real
// participant joins — nothing seeded.
