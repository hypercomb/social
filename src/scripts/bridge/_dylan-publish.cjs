// Publish /dylan to dylan.pluginthematrix.com — drives the SANCTIONED panel
...
//
//   node scripts/bridge/_dylan-publish.cjs
//
// Prereq: the `/dylan` path is present in localStorage `hc:public-branches`
