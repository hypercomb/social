...
const PLACES_ROWS: readonly AttainmentDef[] = [
  ...
  { id: 'place:greenwood', kind: 'place', title: 'The Greenwood', words: 'A whole wood inside the valley’s grove.', art: { kind: 'place', sprite: 'grove' }, when: { done: 'greenwood' }, slot: { board: 'places', slot: 'greenwood' } },
  { id: 'place:root-run', kind: 'place', title: 'The Root Run', words: 'A long cave running east under the Mossback.', art: { kind: 'place', sprite: 'cavern' }, when: { done: 'root-run' }, slot: { board: 'places', slot: 'root-run' } },
  { id: 'place:the-burrow', kind: 'place', title: 'The Burrow', words: 'A shaft dug straight down under the western trees.', art: { kind: 'place', sprite: 'cavern' }, when: { done: 'the-burrow' }, slot: { board: 'places', slot: 'the-burrow' } },
  { id: 'place:undercroft', kind: 'place', title: 'The Undercroft', words: 'Halls under halls, further than the torch reaches.', art: { kind: 'place', sprite: 'cavern' }, when: { done: 'undercroft' }, slot: { board: 'places', slot: 'undercroft' } },
  { id: 'place:the-sump', kind: 'place', title: 'The Sump', words: 'Where the Undercroft’s water goes: a causeway under bats, a goblin warren, a pearl.', art: { kind: 'place', sprite: 'cavern' }, when: { done: 'the-sump' }, slot: { board: 'places', slot: 'the-sump' } },
