...
// a live pointer to a fixed-name canonical root. Clicking the tile portals there
...
// promotes that subtree to /jazz and creates a tile "jazz" here pointing to it.
//
