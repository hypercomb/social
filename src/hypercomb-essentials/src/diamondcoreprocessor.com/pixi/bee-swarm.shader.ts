// diamondcoreprocessor.com/pixi/bee-swarm.shader.ts
// GPU-instanced SDF shader that draws and animates bee avatars.
// One draw call renders all bees — wing flutter, body bob, facing computed on GPU.

import { Shader } from 'pixi.js'

export class BeeSwarmShader {
  ...
  constructor() {
    ...
    this.shader = Shader.from({
      gl: { vertex: BeeSwarmShader.vertexSource, fragment: BeeSwarmShader.fragmentSource },
