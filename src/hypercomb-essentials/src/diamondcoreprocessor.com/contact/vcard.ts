// diamondcoreprocessor.com/contact/vcard.ts
//
...
//
// MOVED, NOT REWRITTEN (everything-is-a-beehavior Phase 2). This file came
// across from hypercomb-shared/ui/contact-card/vcard.ts byte-for-byte below
// the header, because it is a FORMAT: `esc()` and `unesc()` implement RFC
// 6350 §3.4 text escaping, and a single dropped backslash there is a corrupt
// contact in somebody's address book. Nothing about the port had any business
// touching them. It imports nothing at all, which is why it moves as-is.
