...
// The video surface rides the link bundle — a YouTube link is what opens
// it. ONE importer: dup-inlining rule.
import './youtube-viewer.view.js'
...
const LINK_OWNER = '@diamondcoreprocessor.com/TileLinkActionDrone'
