...
// (The `cell:fresh` listener that used to live here cleaned the index after
// a create RESET a location's head. A create links the head now — the reset,
// and the event, are gone: layer-committer.drone.ts.)
